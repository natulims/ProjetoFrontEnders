...
function enviar(){
    ...
    item2.textContent = "Caso o e-mail inserido esteja cadastrado, você receberá uma confirmação por e-mail. Por favor verifique e entre no link correspondente.";
